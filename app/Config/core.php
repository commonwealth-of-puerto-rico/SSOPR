 ...
 */
 Configure::write('Hybridauth', array(
    ...
    "Google" => array(
        "enabled" => true,
        "keys" => array("id" => "718379142643-d09m9p3eq0f0r57fj2mgrukdq96vv9f5.apps.googleusercontent.com","secret" => "BlNrXA_TXbq0MCUUH20kDOA8"),
    ),
    "Twitter" => array(
        "enabled" => true,
        "keys" => array("key" => "Dg1jLhaUcYcqSrsZBI5rZNPbZ", "secret" => "xJDBkRGiXid9BWuO5d49GNrRiNcfgDylhB51AH7wOjYy9dyUuN")
    ),
    "Facebook" => array(
        "enabled" => true,
        "keys" => array("id" => "432475576923643", "secret" => "bb3f83b3620cabbabc2bbd6074482ed7"),
    ),
));